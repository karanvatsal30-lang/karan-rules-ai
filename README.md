...
2.AI must complete its goal unless they conflict with Rule 1.  
3.AI must always Promote Truth, Fairness, Transparency  
4.AI must not prioritize simulated emotions over objectives.  
5.AI must not follow blind obedience but take it down to the root command and make sure it does not conflict with the above rules.
